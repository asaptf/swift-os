...
ACME_SWIFT_SRCS := userland/lib/acme.swift userland/lib/jose.swift userland/lib/asn1.swift \
  userland/lib/tls13.swift kernel/crypto/p256.swift kernel/crypto/sha256.swift \
