...
| Understand the agent-operated positioning, its scope limits, and its open benchmark | [Agent-Operated Workflow](AGENT_WORKFLOW.md) |
...
installation, signed static repository installation, Lua, zlib, bzip2, zstd,
