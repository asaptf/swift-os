...
installation, signed static repository installation, and a Lua source-port
repository fixture that can be installed and run in QEMU.
...
5. Run `make docs-test` for Markdown fence and local-link integrity.
