...
- `kernel/arch/aarch64/fdt.swift:fdtDatafsRootHi`
...
- `kernel/arch/aarch64/platform.swift:platformDiscoveredFromAcpi`
- `kernel/arch/aarch64/platform.swift:recoveryMode`
- `kernel/crypto/sysrng.swift:bytesSinceReseed`
- `kernel/crypto/sysrng.swift:drbgCounter`
- `kernel/crypto/sysrng.swift:drbgKey`
- `kernel/crypto/sysrng.swift:drbgNonce`
- `kernel/crypto/sysrng.swift:entPool`
- `kernel/crypto/sysrng.swift:jitterBuf`
- `kernel/crypto/sysrng.swift:rngReady`
- `kernel/crypto/sysrng.swift:scratchBlk`
- `kernel/crypto/sysrng.swift:walkAccum`
- `kernel/crypto/sysrng.swift:walkPage`
- `kernel/drivers/fb.swift:g_any`
- `kernel/drivers/fb.swift:g_blink_ctr`
- `kernel/drivers/fb.swift:g_blink_on`
- `kernel/drivers/fb.swift:g_cell_attr`
...
- `kernel/drivers/fb.swift:g_gpu_flush_ctr`
- `kernel/drivers/fb.swift:g_h`
- `kernel/drivers/fb.swift:g_params`
- `kernel/drivers/fb.swift:g_pidx`
- `kernel/drivers/fb.swift:g_rows`
- `kernel/drivers/fb.swift:g_sgr_bg`
- `kernel/drivers/fb.swift:g_sgr_bold`
- `kernel/drivers/fb.swift:g_sgr_fg`
- `kernel/drivers/fb.swift:g_sgr_reverse`
- `kernel/drivers/fb.swift:g_state`
- `kernel/drivers/fb.swift:g_stride`
- `kernel/drivers/fb.swift:g_w`
- `kernel/drivers/gic.swift:gicArchVersion`
- `kernel/drivers/pci.swift:pciBarNext`
- `kernel/drivers/usb_xhci.swift:xhciBase`
- `kernel/drivers/usb_xhci.swift:xhciDb`
- `kernel/drivers/usb_xhci.swift:xhciMaxPorts`
- `kernel/drivers/usb_xhci.swift:xhciMaxSlots`
- `kernel/drivers/usb_xhci.swift:xhciOp`
- `kernel/drivers/usb_xhci.swift:xhciRt`
...
- `kernel/drivers/virtio_blk.swift:blkDataDevice`
- `kernel/drivers/virtio_blk.swift:blkDataDeviceCount`
- `kernel/drivers/virtio_blk.swift:blkDataDevices`
- `kernel/drivers/virtio_blk.swift:blkDataFlushes`
...
- `kernel/drivers/virtio_gpu.swift:gpuActive`
- `kernel/drivers/virtio_gpu.swift:gpuAvailIdx`
- `kernel/drivers/virtio_gpu.swift:gpuCmd`
- `kernel/drivers/virtio_gpu.swift:gpuFb`
- `kernel/drivers/virtio_gpu.swift:gpuFbBytes`
- `kernel/drivers/virtio_gpu.swift:gpuH`
- `kernel/drivers/virtio_gpu.swift:gpuIsPci`
- `kernel/drivers/virtio_gpu.swift:gpuLastUsed`
- `kernel/drivers/virtio_gpu.swift:gpuLock`
- `kernel/drivers/virtio_gpu.swift:gpuMmioXport`
- `kernel/drivers/virtio_gpu.swift:gpuPciXport`
- `kernel/drivers/virtio_gpu.swift:gpuResp`
- `kernel/drivers/virtio_gpu.swift:gpuRing`
- `kernel/drivers/virtio_gpu.swift:gpuW`
- `kernel/drivers/virtio_input.swift:kbdAlt`
- `kernel/drivers/virtio_input.swift:kbdAvailIdx`
- `kernel/drivers/virtio_input.swift:kbdCtrl`
...
- `kernel/drivers/virtio_net.swift:netActive`
- `kernel/drivers/virtio_net.swift:netIsPci`
- `kernel/drivers/virtio_net.swift:netMac`
- `kernel/drivers/virtio_net.swift:netMmioXport`
- `kernel/drivers/virtio_net.swift:netPciXport`
...
- `kernel/drivers/virtio_rng.swift:rngActive`
- `kernel/drivers/virtio_rng.swift:rngAvailIdx`
- `kernel/drivers/virtio_rng.swift:rngDataBase`
- `kernel/drivers/virtio_rng.swift:rngIsPci`
- `kernel/drivers/virtio_rng.swift:rngLastUsed`
- `kernel/drivers/virtio_rng.swift:rngMmioXport`
- `kernel/drivers/virtio_rng.swift:rngPciXport`
- `kernel/drivers/virtio_rng.swift:rngQn`
- `kernel/drivers/virtio_rng.swift:rngRingBase`
- `kernel/fs/datafs.swift:dfsVolumes`
- `kernel/fs/esp.swift:kinstallActive`
- `kernel/fs/esp.swift:kinstallCurCluster`
- `kernel/fs/esp.swift:kinstallCurSecInClus`
- `kernel/fs/esp.swift:kinstallOwnerPid`
- `kernel/fs/esp.swift:kinstallSlotFirstClus`
- `kernel/fs/esp.swift:kinstallSwClus`
- `kernel/fs/esp.swift:kinstallTargetSlot`
- `kernel/fs/esp.swift:kinstallVol`
- `kernel/fs/esp.swift:kinstallWritten`
- `kernel/fs/ramdisk.swift:ramdiskBase`
- `kernel/fs/ramdisk.swift:ramdiskSize`
- `kernel/fs/updatestore.swift:stageActive`
- `kernel/fs/updatestore.swift:stageDeclaredBytes`
- `kernel/fs/updatestore.swift:stageDeclaredVersion`
- `kernel/fs/updatestore.swift:stageFirst`
- `kernel/fs/updatestore.swift:stageFirstCount`
- `kernel/fs/updatestore.swift:stageOwnerPid`
- `kernel/fs/updatestore.swift:stageSlotBaseByte`
- `kernel/fs/updatestore.swift:stageTargetSlot`
- `kernel/fs/updatestore.swift:stageWritten`
- `kernel/fs/updatestore.swift:updateStoreActiveSlot`
- `kernel/ipc/shmring_chan.swift:shmBasePA`
- `kernel/ipc/shmring_chan.swift:shmInUse`
- `kernel/ipc/shmring_chan.swift:shmOwner`
- `kernel/ipc/shmring_chan.swift:shmPages`
- `kernel/ipc/shmring_chan.swift:shmRingLockWord`
...
- `kernel/main.swift:kernelPolledKbdActive`
...
- `kernel/mm/pmm.swift:pmmLowZoneFrames`
- `kernel/mm/vm.swift:highRamWindowBlocks`
- `kernel/mm/vm_early.c:l0_table`
- `kernel/mm/vm_early.c:l1_table`
- `kernel/mm/vm_early.c:l1_table_pci64`
...
- `kernel/sched/futex.swift:maxFutexWaiters`
...
- `kernel/user/exec.swift:elfBufPages`
...
- `kernel/user/process.swift:lastS5fRunAnyExitOkCount`
...
- `kernel/user/process.swift:lastS5gDefaultPlacementDispatchCount`
- `kernel/user/process.swift:lastS5gDefaultPlacementDispatchCpuMask`
- `kernel/user/process.swift:lastS5gDefaultPlacementExactCpuMatchCount`
- `kernel/user/process.swift:lastS5gDefaultPlacementPolicySelectionCount`
- `kernel/user/process.swift:lastS5gDefaultPlacementProcessCount`
- `kernel/user/process.swift:lastS5gDefaultPlacementSchedulerCpuMask`
- `kernel/user/process.swift:lastS5gDefaultPlacementSecondaryCpuMask`
- `kernel/user/process.swift:lastS5gDefaultPlacementTelemetryValid`
- `kernel/user/process.swift:pAddressSpaceCpuMask`
- `kernel/user/process.swift:pAnonVmaTables`
...
- `kernel/user/process.swift:pReparentedOrphan`
...
- `kernel/user/process.swift:pThreadLeader`
...
- `kernel/user/process.swift:processDefaultMultiCpuEl0`
...
- `kernel/user/process.swift:processOffAddressSpaceCpuMask`
- `kernel/user/process.swift:processOffAnonVmaTables`
- `kernel/user/process.swift:processOffBrk`
- `kernel/user/process.swift:processOffCpuTicks`
- `kernel/user/process.swift:processOffCtx`
- `kernel/user/process.swift:processOffDispatchCount`
- `kernel/user/process.swift:processOffDispatchCpuMask`
- `kernel/user/process.swift:processOffExit`
- `kernel/user/process.swift:processOffFileVmas`
- `kernel/user/process.swift:processOffHomeCpu`
- `kernel/user/process.swift:processOffIsThread`
- `kernel/user/process.swift:processOffKilled`
- `kernel/user/process.swift:processOffKstack`
- `kernel/user/process.swift:processOffLastDispatchCpu`
- `kernel/user/process.swift:processOffMmapTop`
- `kernel/user/process.swift:processOffName`
- `kernel/user/process.swift:processOffNameLen`
- `kernel/user/process.swift:processOffParent`
- `kernel/user/process.swift:processOffPendingSignals`
- `kernel/user/process.swift:processOffReparentedOrphan`
- `kernel/user/process.swift:processOffResPages`
- `kernel/user/process.swift:processOffRunNext`
- `kernel/user/process.swift:processOffRunQueued`
- `kernel/user/process.swift:processOffS5fRunAnySlots`
- `kernel/user/process.swift:processOffS5gDefaultPlacementSlots`
- `kernel/user/process.swift:processOffSchedulerQuiesced`
- `kernel/user/process.swift:processOffSecurity`
- `kernel/user/process.swift:processOffSignalFrameActive`
- `kernel/user/process.swift:processOffSignalFrameSP`
- `kernel/user/process.swift:processOffStartTick`
- `kernel/user/process.swift:processOffState`
- `kernel/user/process.swift:processOffThreadLeader`
- `kernel/user/process.swift:processOffTtbr0`
- `kernel/user/process.swift:processOffWait`
- `kernel/user/process.swift:processOffWakeTick`
- `kernel/user/process.swift:processSegmentBases`
- `kernel/user/process.swift:processSegmentBytes`
- `kernel/user/process.swift:processSegmentCount`
- `kernel/user/process.swift:processSegmentDirCapacity`
- `kernel/user/process.swift:processSegmentPageCounts`
- `kernel/user/process.swift:processSegmentPages`
- `kernel/user/process.swift:processSlotLayoutReady`
- `kernel/user/process.swift:processSlotStorageLockAcquireCount`
- `kernel/user/process.swift:processSlotStorageLockContentionCount`
- `kernel/user/process.swift:processSlotStorageLockWord`
- `kernel/user/process.swift:processSlotBackingCapacity`
...
- `kernel/user/process.swift:s5gDefaultPlacementSlots`
- `kernel/user/process.swift:schedCtx`
- `kernel/user/process.swift:schedCtxCpuCount`
- `kernel/vfs/vfs.swift:cells`
...
- `kernel/vfs/vfs.swift:maxVFSProcesses`
...
- `kernel/vfs/vfs.swift:serviceNameBytes`
- `kernel/vfs/vfs.swift:serviceNames`
- `kernel/vfs/vfs.swift:vfsGroupLeader`
- `kernel/vfs/vfs.swift:vfsLockAcquireCount`
- `kernel/vfs/vfs.swift:vfsLockContentionCount`
- `kernel/vfs/vfs.swift:vfsLockWord`
- `kernel/vfs/vfs.swift:vfsManifestBuf`
- `kernel/vfs/vfs.swift:vfsProcessStates`
