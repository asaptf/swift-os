...
- **Not** fully implemented. C1-C5f, C5 proper, and the full C6a–C6d cell lifecycle
  exist; richer IPC and the C6e end-to-end "service per cell" payoff (plus richer
  per-cell limits) remain planned work.
