...
- **Not** fully implemented. C1-C5f, C5 proper, and the full C6a–C6e cell arc exist
  (accounting → creation → namespace → lifecycle → one-service-per-cell). Richer IPC,
  richer per-cell limits (handle/CPU caps), nested cells, and lifting a production
