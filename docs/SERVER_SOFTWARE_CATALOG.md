...
| `proc-basic` | `spawn`/`exec`, `waitpid`, pipes, `pipe2`, fd inheritance/close-on-exec, `dup2`, basic signals, and exit status propagation. `fork` is not assumed unless listed explicitly. |
