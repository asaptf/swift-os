...
| `mmap-vm` | `mmap`, `munmap`, `mprotect`, page permissions, executable mappings if JIT is enabled, multi-MiB mappings covered by `largemmapprobe`, guard pages, address-space layout control, and signal/trap reporting. |
