...
static-host ports fixture for Lua, zlib, bzip2, zstd, ca-certificates, pcre2, tzdata,
...
- Source-built Lua, zlib, bzip2, zstd, pcre2, nginx, and sqlite packages plus the ca-certificates/tzdata data packages
