...
static-host ports fixture for Lua, zlib, bzip2, ca-certificates, pcre2, tzdata,
...
- Source-built Lua, zlib, bzip2, pcre2, nginx, and sqlite packages plus the ca-certificates/tzdata data packages
