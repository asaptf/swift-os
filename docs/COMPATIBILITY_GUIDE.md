...
static-host ports fixture for Lua, zlib, bzip2, zstd, xz, ca-certificates, pcre2, tzdata,
...
- Source-built Lua, zlib, bzip2, zstd, xz, pcre2, nginx, and sqlite packages plus the ca-certificates/tzdata data packages
