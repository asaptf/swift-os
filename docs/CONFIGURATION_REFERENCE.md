...
| `make ports-seed-repo-fixture` | Publish Lua, zlib, bzip2, zstd, xz, libarchive, ca-certificates, pcre2, tzdata, nginx, and sqlite into one signed seed repository. |
...
Generate deploy-specific SSHD material, then stage it into the base image:
