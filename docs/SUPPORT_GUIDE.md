...
| Driver-service/device-discovery smoke (`-smp 4`) | `make c5-device-discovery-test` |
...
| `C5c OK: device discovery manifest matched pseudo input` | C5c registry metadata was discovered and matched before claiming |
