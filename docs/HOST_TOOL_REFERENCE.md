...
| `build/swport` | `make swport` | Validate/list/inspect the ports catalog and validate/fetch/manifest/package/repo-fixture the checked Lua, zlib, bzip2, zstd, ca-certificates, pcre2, tzdata, nginx, and `databases/sqlite` recipes. | `make ports-catalog-test`, `make ports-recipe-test` |
...
| `scripts/build-ports-seed-repo.sh` | `make ports-seed-repo-fixture` | Publish the checked Lua, zlib, bzip2, zstd, ca-certificates, pcre2, tzdata, nginx, and sqlite packages into one signed local seed repository. | `make package-ports-seed-repo-install-test` |
...
current nine-package seed: Lua, zlib, bzip2, zstd, ca-certificates, pcre2,
...
`ports/archivers/zstd/Port.json`, `ports/security/ca-certificates/Port.json`,
...
`make ports-zstd-repo-fixture`, `make ports-ca-certificates-repo-fixture`,
